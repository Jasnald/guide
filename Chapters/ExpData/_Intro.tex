...
\texttt{scripts/e1\_simulation\_run.py} & Simulation run for Experiment 1 (see simulation chapters). \\
\texttt{scripts/e2\_simulation\_run.py} & Simulation run for Experiment 2 (see simulation chapters). \\
\texttt{scripts/setup\_geometry.py} & Geometry preprocessing shared by both experiments. \\
\hline
\end{tabular}
